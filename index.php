            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ms-auto nav-pills" style = "font-size: 16px; font-family: Avenir;">
                    ...
                    <li class="nav-item" style = "vertical-align: middle;">
                        <a class="nav-link" href="matchesList.php" style = "display: flex; vertical-align: middle;">Matches<span style="padding-left: 10px;" class="badge bg-secondary">New</span></a>
                    </li>
                    <li class="nav-item">
